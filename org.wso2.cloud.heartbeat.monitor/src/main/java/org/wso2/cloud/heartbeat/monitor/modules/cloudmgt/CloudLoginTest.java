...
public class CloudLoginTest implements Job{

	/**
	 * @param args
	 */
	
	   private static final Log log = LogFactory.getLog(TenantLoginTest.class);
	    private final String TEST_NAME = "CookieLoginTest";
	    ...
	    private String login(){
	    	String cookie = null;
	        try {
	            cookie= carbonAuthenticatorClient.login(tenantUser, tenantUserPwd, hostName);
